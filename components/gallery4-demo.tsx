...
const demoData: Gallery4Props = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Learn how Astro's Islands Architecture and zero-JS-by-default approach is helping developers build faster websites while maintaining rich interactivity where needed.",
